                    ...
                    >
                      <div class="card-body" data-wheel-propagation="true">
												<form class="" action="server.php" method="post">
													...
													<div class="form-group">
														<label>Нэр</label>
														<input type="text" name="title" class="form-control" placeholder="Монгол нэршил">
													</div>
													<div class="form-group">
														<label>Name</label>
														<input type="text" name="title_en" class="form-control" placeholder="Тус хэлээр">
													</div>
													<div class="form-group" style="position: relative;">
	              						<label for="post">Монгол</label>
	                        ...
	                        <div class="form-group" style="position: relative;">
	              						...
	              						<textarea name="body_en" id="body_mon_2" class="form-control" cols="30" rows="5" ></textarea>
													...
													<div class="form-group">
		                         <button type="submit" name="insert_data" class="btn btn-success">Оруулах</button>
		                       </div>
												</form>
                      </div>
                    </div>
